...
const AboutMe = () => {
  return (
    <section id="about" className="px-4 p-20 ">
      <p className="text-center mb-20 text-5xl font-bold">About Me</p>
      <div className="grid grid-cols-1 md:grid-cols-2  flex  justify-between px-13  ">
        <div className="flex  flex-col  ">
          <p className="py-3 pl-3 mt-3 leading-8 text-xl text-gray-400">
            ...
            includes PyTorch, TensorFlow, Scikit-learn.
          </p>
        ...
        <div className="flex flex-row-reverse ">
          <img
            className="rounded-4xl w-5/6 h-[600px] object-cover transition-transform duration-350 hover:rotate-5 hover:scale-105 "
            src={img}
          />
        </div>
      </div>
